class Triples_Data:
    ...
    def __init_data(self):
        ...
        for (h, r, t) in self.train_triples:
            self.__add_dict_kv(self.r_hs_train, r, h)  #关系r有哪些h的set
            self.__add_dict_kv(self.r_ts_train, r, t)  #关系r有哪些t的set

        for r in self.r_hs_train.keys():
            self.r_hs_train[r] = list(self.ents - self.r_hs_train[r]) # 所有与关系r没有关系的h的list
            self.r_ts_train[r] = list(self.ents - self.r_ts_train[r]) # 所有与关系r没有关系的t的list
